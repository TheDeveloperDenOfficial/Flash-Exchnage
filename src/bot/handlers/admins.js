...
async function handleAdmins(ctx) {
  ...
  const msg = `👥 <b>Admin Users</b>\n━━━━━━━━━━━━━━━━━━━━\n\n${lines}\n━━━━━━━━━━━━━━━━━━━━`;

  // Remove buttons — not shown for bootstrap admin
...
async function handleAdminRemove(ctx, telegramId) {
  ...
  try {
    await ctx.telegram.sendMessage(id, '⛔ You have been removed as a Flash Exchange admin.');
  } catch {}

...
<div class="nk-wrap">
                                ...
                                <div class="col-lg-12 col-xl-10 text-center">
                                    <div class="banner-caption wide-auto-xl pdb-l pdt-r tc-light">
                                        ...
                                        <div class="cpn-text cpn-text-s1 cpn-text-center">
                                            <p class="lead animated" data-animate="fadeInUp" data-delay="1.35">Purchase Flash tokens instantly through our secure blockchain-powered platform.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-8 col-lg-10">
                                    ...
                                    <div class="token-status bg-white token-status-s6 shadow-dark round mb-5 animated" data-animate="fadeInUp" data-delay="1.65">
                                        ...
                                        <div class="token-buy-form">
                                            ...
                                            <div class="field-item pb-3">
                                                <label class="field-label" for="token_chain">Receive FLASH On</label>
                                                <div class="field-wrap" id="fe-chain-wrap" style="position:relative;">
                                                    <select id="token_chain" name="token_chain" style="display:none;">
                                            ...
                                            <div class="field-item pb-4">
                                                <label class="field-label" id="wallet-label" for="receiving_wallet">Receiving Wallet Address</label>
                                                <div class="field-wrap">
                                                    <input type="text" id="receiving_wallet" name="receiving_wallet" class="input-bordered" placeholder="Select a chain first" required autocomplete="off">
                                                </div>
                                                <p id="wallet-hint" style="font-size:11px;color:#888;margin-top:4px;">Select a chain to see where FLASH tokens will be sent</p>
                                                <p id="wallet-validate-msg" style="font-size:11px;margin-top:4px;display:none;"></p>
                                            </div>
                                    ...
                                    <div id="fe-marquee-wrap" style="display:none;overflow:hidden;background:linear-gradient(90deg,#38385f,#5a3fa0,#38385f);border-radius:0 0 16px 16px;padding:10px 0;margin-top:-4px;">
                                        <div id="fe-marquee-track" style="display:flex;white-space:nowrap;will-change:transform;">
                                            <span id="fe-marquee-text" style="font-size:13px;color:#fff;padding:0 60px;flex-shrink:0;letter-spacing:.3px;"></span>
                                            <span id="fe-marquee-text-clone" aria-hidden="true" style="font-size:13px;color:#fff;padding:0 60px;flex-shrink:0;letter-spacing:.3px;"></span>
                                        </div>
                                    </div>
    ...
    <main class="nk-pages">
        ...
        <section class="section bg-theme-alt ov-h pb-0 tc-light">
            ...
            <div class="container">
                <div class="section-head section-head-s4 wide-auto-sm text-center">
                    <h2 class="title title-s2 title-s2-alt animated" data-animate="fadeInUp" data-delay=".1">How It Works</h2>
                </div>
                <div class="nk-block">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9 pt-lg-5 mt-xl-4">
                            <div class="gutter-vr-30px">
                                <div class="feature feature-inline feature-md-reverse animated" data-animate="fadeInUp" data-delay=".2">
                                    <div class="feature-icon feature-icon-s7"><em class="icon ti ti-layers"></em></div>
                                    <div class="feature-text"><h5 class="title title-sm">Multi-Network Payments</h5><p>Pay with BNB, ETH, TRX, or USDT across BSC, Ethereum, and TRON networks — your choice, no restrictions.</p></div>
                                </div>
                                <div class="feature feature-inline feature-md-reverse animated" data-animate="fadeInUp" data-delay=".3">
                                    <div class="feature-icon feature-icon-s7"><em class="icon ti ti-lock"></em></div>
                                    <div class="feature-text"><h5 class="title title-sm">Unique Order Fingerprint</h5><p>Every order gets a unique exact crypto amount so your payment is matched to your order automatically — no manual tracking needed.</p></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-9 pt-lg-5 mt-xl-4 order-lg-last">
                            <div class="gutter-vr-30px">
                                <div class="feature feature-inline animated" data-animate="fadeInUp" data-delay=".4">
                                    <div class="feature-icon feature-icon-s7"><em class="icon ti ti-rocket"></em></div>
                                    <div class="feature-text"><h5 class="title title-sm">Instant Auto-Delivery</h5><p>Once your payment is detected on-chain, FLASH tokens are automatically sent to your wallet — no signups, no delays, no middlemen.</p></div>
                                </div>
                                <div class="feature feature-inline animated" data-animate="fadeInUp" data-delay=".5">
                                    <div class="feature-icon feature-icon-s7"><em class="icon ti ti-reload"></em></div>
                                    <div class="feature-text"><h5 class="title title-sm">Live Order Tracking</h5><p>Track your order in real time from payment detection through to confirmed token delivery, right from the purchase page.</p></div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="section pb-5 bg-white ov-h" id="faqs">
            <div class="container">
                <div class="section-head section-head-s4 wide-auto-sm text-center">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10 col-xl-8">
                            <div class="accordion accordion-s1 accordion-faq animated" data-animate="fadeInUp" data-delay=".2" id="faq-67">
                                ...
                                <div class="accordion-item accordion-item-s4 bg-light-alt">
                                    <h5 class="accordion-title collapsed" data-bs-toggle="collapse" data-bs-target="#faq-67-5">What wallet address do I enter? <span class="accordion-icon accordion-icon-s2"></span></h5>
                                    <div id="faq-67-5" class="collapse" data-bs-parent="#faq-67">
                                        <div class="accordion-content"><p>Enter the BEP-20 wallet address (starting with 0x) where you want to receive your FLASH tokens. This must be a wallet you control — such as MetaMask or Trust Wallet. Do not enter an exchange deposit address.</p></div>
                                    </div>
                                </div>
                                <div class="accordion-item accordion-item-s4 bg-light-alt">
                                    <h5 class="accordion-title collapsed" data-bs-toggle="collapse" data-bs-target="#faq-67-6">What happens if my order expires before I pay? <span class="accordion-icon accordion-icon-s2"></span></h5>
                                    <div id="faq-67-6" class="collapse" data-bs-parent="#faq-67">
                                        <div class="accordion-content"><p>Orders expire after the countdown timer runs out. If you pay after expiry but with the exact correct amount, your payment will still be matched and tokens will be sent. If the amount doesn't match any order, our team will review it manually.</p></div>
                                    </div>
                                </div>
                                <div class="accordion-item accordion-item-s4 bg-light-alt">
                                    <h5 class="accordion-title collapsed" data-bs-toggle="collapse" data-bs-target="#faq-67-7">Can I buy using USDT on multiple networks? <span class="accordion-icon accordion-icon-s2"></span></h5>
                                    <div id="faq-67-7" class="collapse" data-bs-parent="#faq-67">
                                        <div class="accordion-content"><p>Yes. We accept USDT on BSC (BEP-20), Ethereum (ERC-20), and TRON (TRC-20). Select your preferred network from the payment method dropdown when placing your order.</p></div>
                                    </div>
                                </div>
                                <div class="accordion-item accordion-item-s4 bg-light-alt">
                                    <h5 class="accordion-title collapsed" data-bs-toggle="collapse" data-bs-target="#faq-67-8">Is there a minimum purchase amount? <span class="accordion-icon accordion-icon-s2"></span></h5>
                                    <div id="faq-67-8" class="collapse" data-bs-parent="#faq-67">
                                        <div class="accordion-content"><p>Yes, there is a minimum order quantity set by the platform. The minimum amount is displayed on the purchase form. Orders below this threshold will not be accepted.</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
